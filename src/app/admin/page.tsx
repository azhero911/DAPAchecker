...
export default function AdminPage() {
  ...
  return (
    <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-8 py-10 flex-grow text-gray-800">
      <div className="bg-white border-2 border-gray-300 rounded-xl p-8 sm:p-10 shadow-sm mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-8 text-base">
          <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <span className="text-3xl font-black text-gray-900">1,420</span>
          ...
          <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <span className="text-3xl font-black text-[#1D4ED8]">78.4%</span>
          ...
          <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <span className="text-3xl font-black text-emerald-700">82 ms</span>
          ...
          <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <span className="text-3xl font-black text-purple-700">85,800</span>
