    ...
    <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-8 py-12 text-gray-800">
      ...
      <div className="bg-white border-2 border-gray-300 rounded-xl p-8 sm:p-12 shadow-sm">
        ...
        <div className="space-y-6 text-base sm:text-lg leading-relaxed text-gray-700">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-gray-900 pt-4">Why We Built DAPA Metrics</h2>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-gray-900 pt-4">Our Data Principles</h2>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
            <Link href="/" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1D4ED8] hover:bg-[#1E40AF] text-white font-bold rounded-lg transition text-base">
              Try the Bulk DA PA Checker Free →
            </Link>
            <Link href="/contact" className="text-gray-600 hover:text-blue-700 font-bold text-base">
              Contact our team
            </Link>
          </div>
        </div>
